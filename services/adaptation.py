...
FIELDS: list[tuple[str, str, str, list | None]] = [
    ...
    # Section 3: Оборудование ТЗ (B=ГО, C=Кол-во/Комментарий)
    ...
    ("cool_shelves_count",       "C58", "Холодильные горки — кол-во",               None),
    ("cool_shelves_1500",        "B59", "Холодильные горки H 1500",                 OPTS_REPLACE),
    ("cool_shelves_1500_count",  "C59", "Холодильные горки H 1500 — кол-во",        None),
    ...
    ("freezer_cabinets_count",   "C66", "Морозильные шкафы — кол-во",               None),
